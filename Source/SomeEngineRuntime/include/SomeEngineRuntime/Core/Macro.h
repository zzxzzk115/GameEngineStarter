...
// Core log macros
#define SOME_ENGINE_CORE_TRACE(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetCoreLogger()->trace(__VA_ARGS__)
#define SOME_ENGINE_CORE_INFO(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetCoreLogger()->info(__VA_ARGS__)
#define SOME_ENGINE_CORE_WARN(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetCoreLogger()->warn(__VA_ARGS__)
#define SOME_ENGINE_CORE_ERROR(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetCoreLogger()->error(__VA_ARGS__)
#define SOME_ENGINE_CORE_CRITICAL(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetCoreLogger()->critical(__VA_ARGS__)

// Client log macros
#define SOME_ENGINE_TRACE(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetClientLogger()->trace(__VA_ARGS__)
#define SOME_ENGINE_INFO(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetClientLogger()->info(__VA_ARGS__)
#define SOME_ENGINE_WARN(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetClientLogger()->warn(__VA_ARGS__)
#define SOME_ENGINE_ERROR(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetClientLogger()->error(__VA_ARGS__)
#define SOME_ENGINE_CRITICAL(...) \
    ::SomeEngineRuntime::g_RuntimeGlobalContext.LoggerSys->GetClientLogger()->critical(__VA_ARGS__)
...
#define SOME_ENGINE_INTERNAL_ASSERT_GET_MACRO(...) \
    SOME_ENGINE_EXPAND_MACRO(SOME_ENGINE_INTERNAL_ASSERT_GET_MACRO_NAME( \
        __VA_ARGS__, SOME_ENGINE_INTERNAL_ASSERT_WITH_MSG, SOME_ENGINE_INTERNAL_ASSERT_NO_MSG))

// Currently accepts at least the condition and one additional parameter (the message) being optional
#define SOME_ENGINE_ASSERT(...) \
    SOME_ENGINE_EXPAND_MACRO(SOME_ENGINE_INTERNAL_ASSERT_GET_MACRO(__VA_ARGS__)(_, __VA_ARGS__))
#define SOME_ENGINE_CORE_ASSERT(...) \
    SOME_ENGINE_EXPAND_MACRO(SOME_ENGINE_INTERNAL_ASSERT_GET_MACRO(__VA_ARGS__)(_CORE_, __VA_ARGS__))
#else
#define SOME_ENGINE_ASSERT(...)
#define SOME_ENGINE_CORE_ASSERT(...)
#endif