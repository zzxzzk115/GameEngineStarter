...
#if defined(EMSCRIPTEN) || defined(__EMSCRIPTEN__) || defined(__wasm__) || defined(__wasm32__) || defined(__wasm64__)
...
#if SOME_ENGINE_PLATFORM_DARWIN || SOME_ENGINE_PLATFORM_LINUX || SOME_ENGINE_PLATFORM_WINDOWS
...
#elif SOME_ENGINE_PLATFORM_EMSCRIPTEN
